...
Route::get('/make-role', function(){
    ...
    $permissionAdmin = Permission::create(['name' => 'manage']);

    $roleAdmin->givePermissionTo($permissionAdmin);

    $roleStaff = Role::create(['name' => 'store']);
    $permissionStaff = Permission::create(['name' => 'store permission']);

    $roleStaff->givePermissionTo($permissionStaff);

    $roleStudent = Role::create(['name' => 'staff']);
    $permissionStudent = Permission::create(['name' => 'staff permission']);
...
Route::get('/assign-role', function(){
    ...
    $user = User::find(1);
    $user->assignRole(['admin','store', 'staff']);
